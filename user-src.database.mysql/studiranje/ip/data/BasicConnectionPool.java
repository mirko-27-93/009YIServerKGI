 ...
 * @version 1.0
 */
public class BasicConnectionPool extends AbstractConnectionPool implements DBFullURLSwappable, AutoCloseable{
  ...
  public synchronized static BasicConnectionPool isolatedConnectionPool(String databaseFullURL, String databaseName) {
	    return load(databaseFullURL, databaseName);	
  }
